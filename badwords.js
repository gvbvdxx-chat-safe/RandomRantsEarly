    ...
    var checkBadWords = function (ogTXT) {
      ...
      for (var i in badWordsEncoded) {
        if (
          ...
          //many pepole get confused with this function
    ...
    window.filterBadWords = function (text, censorthing) {
      ...
      while (i < words.length) {
        if (checkBadWords(words[i])) {
          var wordcencored = "";
          wordcencored += "Censored";
          for (var unusedi of words[i]) {
          }
